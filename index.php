...
.nandu {
    width: 100%;
    height: 100vh;
    background: url(../img/bodybg/bg7.png) ;
}
...
<div class="container register" style="font-family: 'IBM Plex Sans', sans-serif;">
                ...
                <div class="row">
                    <div class="col-md-3 register-left" style="margin-top: 10%;right: 15%;size:6;background-image:url('background:url('https://tse2.mm.bing.net/th?id=OIP.U5vjnAWV9XylmpzPEAhqNAHaGr&pid=Api&P=0&h=180');" >
                    <h3 style="margin-left:20%;" >Welcome</h3>
                        <img src="images\baby_img.jpeg" style="width:500px; height:500px;border-radius:50%;" >
                    ...
                    <div class="col-md-9 register-right" style="margin-top: 40px;left: 80px;">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                <h3 class="register-heading">Enter Infant Details</h3>
                                <form method="post" action="func2.php">
                                <div class="row register-form">
                                    
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <input type="text" class="form-control"  placeholder="Mother Name *" name="fname"  onkeydown="return alphaOnly(event);" required/>
                                        </div>
                                        <div class="form-group">
                                            <input type="text" class="form-control" placeholder="Your Email *" name="email"  />
                                        </div>
                                        <div class="form-group">
                                            <input type="date" class="form-control" placeholder="DOB *" id="password" name="password" onkeyup='check();' required/>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <input type="text" class="form-control" placeholder="Birth Place *" name="lname" onkeydown="return alphaOnly(event);" required/>
                                        </div>
                                        
                                        <div class="form-group">
                                            <input type="number" step="0.01"  name="contact" class="form-control" placeholder="Height/Weight *"  />
                                        </div>
                                        <div class="form-group">
                                            <input type="date" class="form-control"  id="cpassword" placeholder="Confirm DOB *" name="cpassword"  onkeyup='check();' required/><span id='message'></span>
                                        </div>
