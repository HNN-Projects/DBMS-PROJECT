  ...
  <div class="col-md-8" style="margin-top: 3%;">
    ...
    <div class="tab-pane fade" id="list-pat" role="tabpanel" aria-labelledby="list-pat-list">
      ...
      <form class="form-group" action="patientsearch.php" method="post">
        <div class="row">
        <div class="col-md-10"><input type="email"  name="patient_contact" placeholder="Enter Email" class = "form-control"></div>
              ...
              <table class="table table-hover">
                <thead>
                  ...
                  <th scope="col">Patient ID</th>
                    ...
                    <th scope="col">Infant Place Of Birth</th>
                    <th scope="col">Gender</th>
                    <th scope="col">Email</th>
                    <th scope="col">Infant Weight</th>
      ...
      <form class="form-group" action="appsearch.php" method="post">
        <div class="row">
        <div class="col-md-10"><input type="email"  name="app_contact" placeholder="Enter Email" class = "form-control"></div>
...
<div class="tab-pane fade" id="list-messages" role="tabpanel" aria-labelledby="list-messages-list">...</div>
      ...
      <form class="form-group" action="messearch.php" method="post">
        <div class="row">
        <div class="col-md-10"><input type="text" name="mes_contact" placeholder="Enter Infant  ID" class = "form-control"></div>
